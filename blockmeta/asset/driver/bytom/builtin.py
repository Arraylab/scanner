...
class BuiltinDriver:
	...
	def request_asset_info(self, asset_id, page=1, tag='txs'):
		asset_object = self.mongo_cli.get_one(table=FLAGS.asset_info, cond={FLAGS.asset_id: asset_id})
	...
	def normalize_tx(self, tx):
		fields = ['block_hash', 'block_height', 'id', 'inputs', 'outputs', 'size', 'status_fail', 'time_range', 'version']
